<?php namespace Mosaicpro\HtmlGenerators\Table;

use Mosaicpro\HtmlGenerators\Core\WidgetCreatorAbstract;

/**
 * Class Table
 * @package Mosaicpro\HtmlGenerators\Table
 */
        ...
        foreach($item as $row)
        {
            ...
            foreach($data as $column => $value)
            {
                ...
                if (is_array($value))
                {
                    ...
                    foreach($value as $v)
                    {
                        if (is_subclass_of($v, 'Mosaicpro\HtmlGenerators\Core\WidgetCreatorAbstract'))
                ...
                {
                    if (is_subclass_of($value, 'Mosaicpro\HtmlGenerators\Core\WidgetCreatorAbstract'))
